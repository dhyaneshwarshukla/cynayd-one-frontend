...
import { BFF_PREFIX } from '@/lib/bff';
...
export interface AdminAppsManagementProps {
  /** When true, lists all platform apps (super admin). Omit for org-scoped admin view. */
  superAdminScope?: boolean;
}

export default function AdminAppsManagement({ superAdminScope = false }: AdminAppsManagementProps) {
  const isSuperAdminScope = superAdminScope;
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('API Client base URL:', BFF_PREFIX);
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <div className="mt-3 text-sm text-red-600">
                  ...
                  <p>• API proxy: {BFF_PREFIX} → API_URL (server)</p>
                  <p className="mt-2">
                    <a href="/auth/login" className="text-blue-600 hover:text-blue-500 underline">
