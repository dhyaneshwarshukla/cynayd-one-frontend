...
import './api-docs.css';
import { BFF_PREFIX, toBffUrl } from '@/lib/bff';
...
export default function ApiDocumentationPage() {
  ...
  const apiDocsUrl = toBffUrl('/api-docs');
  const [apiExampleBase, setApiExampleBase] = useState(BFF_PREFIX);

  useEffect(() => {
    setApiExampleBase(`${window.location.origin}${BFF_PREFIX}`);
          ...
          <div className="api-docs-quick-start-step">
            ...
            <div className="api-docs-code-block">
              <div className="api-docs-code-header">
                ...
                <button 
                  onClick={() => copyToClipboard(`curl -X POST ${apiExampleBase}/sso/auth/register \\
          ...
          <div className="api-docs-quick-start-step">
            ...
            <div className="api-docs-code-block">
              <div className="api-docs-code-header">
                ...
                <button 
                  onClick={() => copyToClipboard(`curl -X POST ${apiExampleBase}/sso/permissions/assign \\
  -H "Content-Type: application/json" \\
          ...
          <div className="api-docs-quick-start-step">
            ...
            <div className="api-docs-code-block">
              <div className="api-docs-code-header">
                ...
                <button 
                  onClick={() => copyToClipboard(`curl -X POST ${apiExampleBase}/drive/users/sync \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \\
  ...
  "quota": 10737418240
            ...
            <div className="api-docs-code-block" style={{ marginTop: '1rem' }}>
              <div className="api-docs-code-header">
                ...
                <button 
                  onClick={() => copyToClipboard(`curl -X POST ${apiExampleBase}/hr/users/uuid-123/profile \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \\
                ...
                <div>
                  ...
                  <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button 
                        onClick={() => copyToClipboard(`curl -X ${selectedEndpoint.method} ${apiExampleBase}${selectedEndpoint.path.replace(/^\/api/, '')} \\
  -H "Content-Type: application/json" \\
